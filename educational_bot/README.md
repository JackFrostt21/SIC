...
```
python manage.py dumpdata app.Model > dump/Model.json
```

```
python manage.py loaddata dump/Model.json
```
...
```
python manage.py dumpdata educational_module.TrainingCourse > dump/TrainingCourse.json
```
...
```
cd existing_repo
git remote add origin https://gitlab.eriell.com/nikolay.kanygin/educational_bot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eriell.com/nikolay.kanygin/educational_bot/-/settings/integrations)
