...
from app.core.middleware import LoggedInUser
from app.core.models import ChangeLog, ACTION_CREATE, ACTION_UPDATE, ACTION_DELETE
...
def journal_save_handler(sender, instance, created, **kwargs):
    if isinstance(instance, ChangeLoggableMixin):
        ...
        # history = merge(last_saved['changed'], instance.get_changed_fields())
