...
class UserTest(BaseModel, BaseRowStateModel, ChangeLoggableMixin):
    ...
    user_answer = models.JSONField(verbose_name=_("Ответы пользователя"), default=default_user_answer)
    complete = models.BooleanField(default=False, verbose_name=_("Успешно"))

    quantity_correct = models.PositiveSmallIntegerField(null=True, blank=True, verbose_name=_("Процент правильных ответов"))
    quantity_not_correct = models.PositiveSmallIntegerField(null=True, blank=True, verbose_name=_("Процент не правильных ответов"))
