...
class TrainingCourse(BaseModel, ChangeLoggableMixin):
    ...
    user = models.ManyToManyField("bot.TelegramUser", null=True, blank=True, verbose_name=_("user"))
    group = models.ManyToManyField("bot.TelegramGroup", null=True, blank=True, verbose_name=_("group"))
...
log_active([TrainingCourse, CourseTopic, Subtopic, TopicQuestion, AnswerOption])
