...
from app.educational_module.models import TrainingCourse, CourseTopic, TopicQuestion, AnswerOption, Subtopic, Company, CourseDirection
...
class TopicQuestionModeAdmin(admin.ModelAdmin):
    # list_display = ('training', 'topic', 'title')
    list_display = ('training', 'title')
    # list_display_links = ('training','topic', 'title')
    list_display_links = ('training', 'title')
    search_fields = ('title',)
    # list_filter = ('training', 'topic', 'title',)
