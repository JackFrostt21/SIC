...
JET_SIDE_MENU_ITEMS = [
    {'label': _('BotSettings_JET_MENU_ITEMS'),
     'items': [
         {'name': 'bot.telegramuser', 'label': _('TelegramUser_JET_MENU_ITEMS')},
         {'name': 'bot.telegramgroup', 'label': _('TelegramGroup_JET_MENU_ITEMS')},
         {'name': 'bot.setslist', 'label': _('Settings_JET_MENU_ITEMS')},
         {'name': 'admin.logentry', 'label': _('History_JET_MENU_ITEMS')},
         {'name': 'bot.UserAction', 'label': _('Actionuser_JET_MENU_ITEMS')}
         
     ]},
    {'label': _('Educational_JET_MENU_ITEMS'), 'items': [

        {'name': 'educational_module.trainingcourse', 'label': _('TrainingCourse_JET_MENU_ITEMS')},
        {'name': 'educational_module.coursetopic', 'label': _('CourseTopic_JET_MENU_ITEMS')},
    ...
    {'label': _('AdministratorSettings_JET_MENU_ITEMS'), 'permissions': ['user.user'], 'items': [
        # {'name': 'auth.user', 'label': _('Users_JET_MENU_ITEMS')},
        {'name': 'users.customuser', 'label': _('Users_JET_MENU_ITEMS')}, #замена на кастомную модель User
        {'name': 'auth.group', 'label': _('Groups_JET_MENU_ITEMS')},
        {'name': 'core.changelog', 'label': _('Model logging_JET_MENU_ITEMS')},
