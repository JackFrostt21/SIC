<template>
  <div class="flex flex-col gap-[10px] h-auto md:w-[1040px] w-full">

    <div class="md:w-[1040px] w=auto h-[30px]">
    ...
    <p v-if="no_courses" class="h-[22px] font-semibold text-[16px] leading-[1] tracking-[0] text-[#8A8A8A] font-sans mb-[40px]">В настоящий момент для вас нет доступных программ обучения.
