...
from .resources import JobTitleResource, DepartmentResource, CompanyResource


@admin.register(JobTitle)
class JobTitleAdmin(ImportExportModelAdmin):
    resource_class = JobTitleResource
    list_display = ("name", "source_id", "is_actual", "created_at")
...
class DepartmentAdmin(ImportExportModelAdmin):
    ...
    list_display = ("name", "company", "parent", "job_titles_count", "is_actual")
    list_filter = ("is_actual", "company", "parent")
    search_fields = ("name", "source_id", "company__name")
...
class SettingsBotAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        ...
        "updated_at",
        "preview_image_start",
        "preview_image_list_courses",
        "preview_image_settings",
        "preview_image_progress",
        "preview_image_test_passed",
        "preview_image_test_failed",
        "preview_image_test_start",
        "preview_image_help",
        "preview_image_progress_good",
    ...
    fieldsets = (
        ...
        ("Справочная информация", {"fields": ("bot_help_text", "bot_version")}),
        (
        ...
        (
            ...
            {"classes": ("collapse",), "fields": ("image_help", "preview_image_help")},
        ),
        ("Текстовые сообщения для бота", {"fields": ("admin_contact_message",)}),
    )
