...
###ВЫВЕСТИ КОМАНДЫ старт список заявка
...
async def send_data_to_external_api(user_data):
    ...
    headers = {"Authorization": "Basic dGVtcC51c2VyQHRlbXAudXNlcjp6NXMyWW5BNQ=="}
    ...
    if email_check.fullmatch(message.text):
        ...
        if user:
            ...
            if response_data and response_data.get("ok") == 1:
                ...
                ### + скриншоты от Димы и хранить скрины в базе
                ...
                error_message = {
                    ...
                    "Неизвестная ошибка при регистрации. Пожалуйста, попробуйте выполнить регистрацию позже",
                )
